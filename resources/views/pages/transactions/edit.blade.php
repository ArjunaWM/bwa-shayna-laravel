    ...
    <div class="card">
        ...
        <div class="card-body card-blocl">
            <form action="{{ route('transactions.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="price" class="form-control-label">Nomor</label>
                    <input type="number" name="price" value="{{ old('number') ? old('number') : $item->number }}" class="form-control @error('number') is-invalid @enderror">
